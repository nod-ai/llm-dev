...
```
ROCR_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 iree-run-module  \
--hip_use_streams=true --device_allocator=caching  \
...
--device=hip://0  --device=hip://1  --device=hip://2  --device=hip://3  --device=hip://4  \
--device=hip://5  --device=hip://6  --device=hip://7  \
