...
| Sharding | 8 CPU core sharded FP16 numerically verified @boian. (Wrong numerics?) ETA:10/25 | 8 GPU sharding for FP16 and FP8 compiling for MI300 @rob/@Ian sharding verified on CPU, compilation fails (completed, Kyle to use it to generate sharded MLIR for 405B) | 8 GPU sharding for FP16 and FP8 numerics verified for MI300 @boian/@rob | 
...
| Shortfin Serving | |llama3.1 8B FP16 iree compiled working using shortfin @xida (in-debug async wait issue, ETA: 10/25) |
