...
## Llama Variants
| Model | TP | Prefill | Decode | Shortfin | Tracy Profile | dump file| Comments|
|-------|----|---------|--------|----------|---------------|----------|---------|
|Llama-3.1-8B | TP1 | | | | | | |
|Llama-3.1-8B | TP8 | | | | | | |
...
|Llama-3.1-70B-Instruct | TP8 | no iree-run-module output | PASS | Bad results | | | |
|Llama-3.1-405B | TP8 | | | | | | |
|Llama-3.1-405B-Instruct | TP8 | PASS | PASS | Bad results | | | |
