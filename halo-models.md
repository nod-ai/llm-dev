...
| Serving |- @ean flush out bf16 flux in shortfin for flux (ETA 12/12) <br> - @Xida fix flakiness in batch handling (Done: 12/12) <br> - @Stephen test and ensure sglang/shortfin batch runs work (ETA: 12/12) | - @Stephen Debugging multi-device llms in shortfin (ETA: 12/18) <br> - @Ean debugging fp16 flux pipeline (ETA 12/17) <br> - @Xida Debugging batching issue found in prefill (ETA 12/17)
