...
|Item                          | Previous Week (Jan 6-10) |  Next Week (Jan 13-17) |
|------------------------------|-----------------------|--------------------------|
| Sharktank Modeling           |  < - @Dan Pushing attention fix for bf16 attention fp8 model (ETA 1/6) <br> - @Dan FP8 attention model functionality (ETA 1/7) <br> - @Boian circular deps fix for context management (ETA 1/6) <br>- @Boian debuging flux numeric issues (ETA 1/7) <br> - @Rob debugging multi-device performance llama issues with iree-run-module (ETA 1/7) <br> - @Ian vae ci debugging (1/6) <br>  - @Ian VAE bf16 numerics verification and debugging (1/7) | - @Ean get all controlnet pipeline models running (Done 1/14) <br> - @Boian debugging numerics in flux-transformer (ETA 1/14) <br> - @Rob look at padding top matmul in prefill (ETA 1/14) <br> - @Rob multi-device tracing still serial and debugging (ETA 1/14) <br> - @Dan Adding fp8 kernel tests (ETA 1/14) <br> - @Dan continuing fp8 70b llama model numeric debugging (ETA 1/24)
| IREE codegeneration          | - @Dan fp8 attention fixes and handoff (Done 1/7) |
| Serving |  - @Ean landing fp32 flux (ETA 1/6) <br> - @Ean PR for bf16 current status (ETA 1/7) <br> - @Ean debug sdxl release issue (ETA 1/6) <br> - @Stephen Continuing multi-device llama debugging in shortfin (ETA 1/7) <br> - @Kyle pick up and finish bf16 shortfin flux support (ETA 1/8) | - @Ean Controlnet pipeline functionality in shortfin (ETA 1/14) <br> - @Kyle fixing up shortfin flux support (ETA 1/14) <br> - @Stephen triaging iree compile regression (ETA 1/14) <br> - @Stephen triaging potential shortfin regression with 70b (ETA 1/14) <br> - @Archana shortfin PPL debugging (ETA 1/14) <br> - @Xida debugging concurrent request numeric issue (ETA 1/14)
| Test Automation              | - @Xida debugging shortfin CI (ETA 1/6) <br> - @Archana ppl seg fault debugging (ETA 1/7) |
| Performance Tuning           | |
