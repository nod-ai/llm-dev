...
| Test Automation              |- @avi: Finish 8B Fp16 automation (ETA: 11/1) <br> - Have automation dashboard showing llama3.1 tests running (Done:11/5) | @Avi Benchmark latency 8b Numbers (decomposed and not for prefill) and TP8 (ETA: 11/11) 
...
|Item                                      | Generate MLIR | Compile to vmfb | IREE invocation | IREE numeric | Serving numeric |
|------------------------------------------|---------------|-----------------|-----------------|--------------|-----------------|
| llama3.1-8B-FP16 (prefill)     |PASS [mlir](https://sharkblobs.blob.core.windows.net/halo-models/llm-dev/llama3_8b/8b_f16_nondecomposed_prefill.mlir)   | PASS [compile](https://gist.github.com/aviator19941/d49e0baca5c6f64a93f8926f99cd111f) | PASS [run](https://gist.github.com/aviator19941/8cc7b1282e69ec87fc4c5e231d28b80f) | tbd | tbd
